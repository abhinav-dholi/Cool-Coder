      ...
      $.ajax({
        ...
        success: function success(data) {
          ...
          if (data.compile_status === "OK") {
            ...
            if (data.run_status.status_detail) $("#outputbox").html("<b> ERROR :  </b>" + data.message + "<br>" + data.run_status.status_detail);else $("#outputbox").html("<b> ERROR <b>");
          }
