...
route.post('/send', (req, res) => {
    const output = `
        ...
        <br>
        <br>
      <h2>This is an online code editor that lets people collaborate in realtime. It allows you to share code in real-time with developers in your 
    ...
    let transporter = nodemailer.createTransport({
      ...
      auth: {
          user: 'aboutabhinavdholi@gmail.com', // generated ethereal user
          pass: 'Aboutabhinavabcd123$'  // generated ethereal password
      },
      // tls:{
    ...
    let mailOptions = {
        from: '"Abhinav" aboutabhinavdholi@gmail.com', // sender address
